...
class Tab2(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.rolePromptIcon = QtWidgets.QLabel()
        self.rolePromptIcon.setPixmap(qta.icon('fa.info-circle',color='#eed202').pixmap(QtCore.QSize(20, 20)))
        self.rolePromptIcon.setMaximumSize(QtCore.QSize(20, 20))
        self.horizontalLayout_8.addWidget(self.rolePromptIcon)
        ...
        self.horizontalLayout_9.addWidget(self.cbx_notCount)
        self.notCountPromptIcon = QtWidgets.QLabel()
        self.notCountPromptIcon.setPixmap(qta.icon('fa.info-circle',color='#eed202').pixmap(QtCore.QSize(20, 20)))
        self.notCountPromptIcon.setMaximumSize(QtCore.QSize(20, 20))
        self.horizontalLayout_9.addWidget(self.notCountPromptIcon)
        self.notCountPrompt = QtWidgets.QLabel()
        self.notCountPrompt.setObjectName("notCountPrompt")
        self.horizontalLayout_9.addWidget(self.notCountPrompt)
        ...
        self.btn_importTextFile.setMinimumSize(QtCore.QSize(150, 40))
        self.btn_importTextFile.setMaximumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.btn_outputTextFile.setMinimumSize(QtCore.QSize(150, 40))
        self.btn_outputTextFile.setMaximumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.msg_roleNotAlpha.setFont(msgFont)
        ...
        self.msg_noInp.setFont(msgFont)
        ...
        self.msg_deleteNotSelect.setFont(msgFont)
        ...
        self.msg_notSave.setFont(msgFont)
    ...
    # 匯入txt檔或csv檔(csv格式需固定)
    def _importTxtOrCsv(self, filePath, extension):
        content = []
